...
void print_performance(struct perf* performance) {
  ...
  1a:	7e250513          	addi	a0,a0,2018 # 7f8 <malloc+0xec>
  1e:	00000097          	auipc	ra,0x0
  22:	630080e7          	jalr	1584(ra) # 64e <printf>
...
int main(void)
{
  ...
  3a:	81250513          	addi	a0,a0,-2030 # 848 <malloc+0x13c>
...
putc(int fd, char c)
{
 ...
 38c:	f56080e7          	jalr	-170(ra) # 2de <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3be:	4a650513          	addi	a0,a0,1190 # 860 <digits>
 3c2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 48a:	3dab8b93          	addi	s7,s7,986 # 860 <digits>
 ...
 5ca:	29290913          	addi	s2,s2,658 # 858 <malloc+0x14c>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7e6:	b64080e7          	jalr	-1180(ra) # 346 <sbrk>
  if(p == (char*)-1)
