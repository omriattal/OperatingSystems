...
putc(int fd, char c)
{
 ...
 3c8:	f4e080e7          	jalr	-178(ra) # 312 <write>
}
...
malloc(uint nbytes)
{
 ...
 7d4:	08a73823          	sd	a0,144(a4) # 860 <freep>
      return (void*)(p + 1);
 ...
 800:	ec4080e7          	jalr	-316(ra) # 6c0 <free>
  return freep;
 ...
 822:	b5c080e7          	jalr	-1188(ra) # 37a <sbrk>
  if(p == (char*)-1)
