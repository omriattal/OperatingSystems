...
malloc(uint nbytes)
{
 ...
 9ee:	0aa73b23          	sd	a0,182(a4) # aa0 <freep>
      return (void*)(p + 1);
 ...
 a1a:	ec4080e7          	jalr	-316(ra) # 8da <free>
  return freep;
 ...
 a3c:	b5c080e7          	jalr	-1188(ra) # 594 <sbrk>
  if(p == (char*)-1)
