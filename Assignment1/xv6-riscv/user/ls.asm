...
fmtname(char *path)
{
  ...
  6a:	ab298993          	addi	s3,s3,-1358 # b18 <buf.0>
...
malloc(uint nbytes)
{
 ...
 a24:	0ea73823          	sd	a0,240(a4) # b10 <freep>
      return (void*)(p + 1);
 ...
 a50:	ec4080e7          	jalr	-316(ra) # 910 <free>
  return freep;
 ...
 a72:	b5c080e7          	jalr	-1188(ra) # 5ca <sbrk>
  if(p == (char*)-1)
